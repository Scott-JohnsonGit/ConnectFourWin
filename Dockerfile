...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:6.0-windows-alpine AS build
...
FROM mcr.microsoft.com/dotnet/aspnet:6.0-windows-alpine AS final
WORKDIR /app
...
ENTRYPOINT ["dotnet", "ConnectFourWin.dll"]
